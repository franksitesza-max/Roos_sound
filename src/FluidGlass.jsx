...
export default function FluidGlass({ mode = 'lens', lensProps = {}, barProps = {}, cubeProps = {} }) {
  ...
  const {
    navItems = [
      ...
      { label: 'Packages', link: 'packages.html' },
      { label: 'DJ', link: 'dj.html' }
    ],
    ...modeProps
  } = rawOverrides;
...
function Images() {
  ...
  return (
    <group ref={group}>
      <Image position={[-2, 0, 0]} scale={[3, height / 1.1, 1]} url="/assets/roos-vinyl.png" />
      <Image position={[2, 0, 3]} scale={3} url="/assets/michael-roos.jpg" />
      <Image position={[-0.6, -height, 6]} scale={[2, 2.4, 1]} url="/assets/hendrik.jpg" />
    </group>
  );
}
